...
namespace CovidWebAPI.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            IOptions<IdentityOptions> identityOptions)
        {
            ...
            _From_SmtpServer = _configuration.GetValue<string>("CovidWebAPI:EmailAccount:From_SmtpServer");
            _From_SmtpServerPort = _configuration.GetValue<int>("CovidWebAPI:EmailAccount:From_SmtpServerPort");
            _From_Name = _configuration.GetValue<string>("CovidWebAPI:EmailAccount:From_Name");
            _From_EmailAdress = _configuration.GetValue<string>("CovidWebAPI:EmailAccount:From_EmailAdress");
            _From_EmailPassword = _configuration.GetSection("CovidWebAPI:EmailAccount")["From_EmailPassword"];
            ...
            var claims = new[]
{
                ...
                new Claim("CovidWebAPI_UserId", user.Id),
            };
            try
            {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration.GetValue<string>("CovidWebAPI:Security:SymmetricSecurityKey")));
