...
namespace CovidWebAPI.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            IOptions<IdentityOptions> identityOptions)
        {
            ...
            _From_SmtpServer = _configuration.GetValue<string>("LS.eCommerce.WebApi:EmailAccount:From_SmtpServer");
            _From_SmtpServerPort = _configuration.GetValue<int>("LS.eCommerce.WebApi:EmailAccount:From_SmtpServerPort");
            _From_Name = _configuration.GetValue<string>("LS.eCommerce.WebApi:EmailAccount:From_Name");
            _From_EmailAdress = _configuration.GetValue<string>("LS.eCommerce.WebApi:EmailAccount:From_EmailAdress");
            _From_EmailPassword = _configuration.GetSection("LS.eCommerce.WebApi:EmailAccount")["From_EmailPassword"];
            ...
            var claims = new[]
{
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration.GetValue<string>("LS.eCommerce.WebApi:Security:SymmetricSecurityKey")));
        ...
        private async Task<ActionResult> _CreateUserAsync(UserInfo model)
        {
            if (model == null)
            {
            ...
            using (var scope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
                ...
                try
                {
                    ...
                    var user = new ApplicationUser
                    {
                        ...
                        Nombre = model.Nombre,
                        TipoDeDocumento = model.TipoDeDocumento,
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var result02 = await _userManager.AddToRoleAsync(user, "AppUser");
                        ...
                        if (result02.Succeeded)
                        {
                            ...
                            //mailKit.Send(user.UserName, user.Email, "Confirma tu Cuenta",
                            //    $"<h2> " + user.UserName + "</h2>" + Environment.NewLine +
