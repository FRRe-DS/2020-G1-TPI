...
namespace Data.Migrations
{
    ...
    [Migration("20200525201635_Tercera")]
            ...
            modelBuilder.Entity("Modelo.AntecedenteEpidemiologicos1", b =>
                {
                    ...
                    b.HasOne("Modelo.FormularioParaAnalisis", "FormularioParaAnalisis")
                        .WithOne("AntecedenteEpidemiologicos1")
                        .HasForeignKey("Modelo.AntecedenteEpidemiologicos1", "FormularioParaAnalisisId")
            ...
            modelBuilder.Entity("Modelo.AntecedenteEpidemiologicos2", b =>
                {
                    b.HasOne("Modelo.FormularioParaAnalisis", "FormularioParaAnalisis")
                        ...
                        .HasForeignKey("Modelo.AntecedenteEpidemiologicos2", "FormularioParaAnalisisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Modelo.EnfermedadesPreviasComorbilidades", b =>
                {
                    b.HasOne("Modelo.FormularioParaAnalisis", "FormularioParaAnalisis")
                        ...
                        .HasForeignKey("Modelo.EnfermedadesPreviasComorbilidades", "FormularioParaAnalisisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Modelo.SignosYSintomas", b =>
                {
                    b.HasOne("Modelo.FormularioParaAnalisis", "FormularioParaAnalisis")
                        ...
                        .HasForeignKey("Modelo.SignosYSintomas", "FormularioParaAnalisisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
